...
.setThumbnail()
.addField(`TigerInLteX  | Teşekkürler`, `**Selam! Ben EMRE (TigerInLteX 'İN geliştiricisi) Öncelikle Botumuzu Eklediğiniz İçin Sizlere Teşekkürlerimi Sunarım**`)
.addField(`TigerInLteX  | Prefix`, `**TigerInLteX 'İN Prefixi(ön eki) = \`{a!}\`\n\n Değiştirebilmek için \`${ayarlar.prefix}prefix\` Yazabilirsiniz.**`)
.addField(`TigerInLteX | Nasıl Kullanılır?`, `**TigerInLteX  botun komutlarını öğrenmek için \`${ayarlar.prefix}yardım\` yazmanız yeterlidir.**`)
.addField(`TigerInLteX  | Linkler`, `**Botun yazı izni açık olan herhangi kanala a!linkler Yazmanız Yeterlidir**`)
            ...
            if (reklam.some(word => msg.content.toLowerCase().includes(word))) {
              try {
                if (!msg.member.hasPermission("MANAGE_MESSAGES")) {
                  ...
                  .setColor(`RED`)
                  .setFooter(`TigerInLteX reklam-küfür engelledi `)
                  .setAuthor (`${msg.author.tag} adlı / ${msg.author.id} id li / kullanıcı reklam-küfür yaptı`)
                    msg.channel.send(embed)                             
                    msg.channel.send(`<@${msg.author.id}> , **Reklam-küfür Yapmak Yasak!**`)
                }             
              } catch(err) {
                console.log(err);
              }
...
client.on("guildMemberAdd", async member => {
  ...
  ///....
  if (!mesaj) {
       return client.channels.cache.get(kanal).send("**__"+ member.user.username +"__ Adlı Kullanıcı Aramıza Katıldı!** **__" + sayaç + "__** **Kişi Olmamıza** **__" + sonuç + "__** **Kişi Kaldı.** **__" + member.guild.memberCount + "__** **Kişiyiz!**");
  }
...
client.on("guildMemberRemove", async member => {
  ...
  if (!mesaj) {
    return client.channels.cache.get(kanal).send("**__" + member.user.username + "__** ** Adlı Kullanıcı Aramızdan Ayrıldı.** **__" + sayaç + "__** ** Kişi Olmamıza** **__" + sonuç + "__** ** Kişi Kaldı.** **__" + member.guild.memberCount + "__** ** Kişiyiz!**");
      }
...
client.on("guildMemberAdd", async member => {
  ...
  if (!mesaj) {
    client.channels.cache.get(kanal).send(" ** __" + member.user.username + "__** ** Hoş Geldin! Otomatik Rolün Verildi Seninle Beraber** **__" + member.guild.memberCount + "__** **Kişiyiz!** ");
