...
const tag = ''   
const erkekrol = message.guild.roles.cache.find(r => r.id === '811890114711388160') //erkek rol id
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '811890114711388160')//erkek rol 2 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '811895854864269324')//kayıtsız id
const genelchat = message.guild.channels.cache.find(c => c.id === '812299218709905418')//genelchat id
