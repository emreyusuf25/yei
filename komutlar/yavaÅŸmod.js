...
exports.run = async(client, message, args) => {
  if (!message.member.hasPermission("MANAGE_CHANNELS")) return message.channel.send(`**Bu komutu kullanabilmek için __Kanalları Yönet__ yetkisine sahip olmalısın.**`);
